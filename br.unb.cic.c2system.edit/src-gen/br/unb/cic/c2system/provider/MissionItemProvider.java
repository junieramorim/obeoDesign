...
/**
 * This is the item provider adapter for a {@link br.unb.cic.c2system.Mission} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MissionItemProvider extends AllocableItemProvider {
	/**
	...
	protected void addCompletenessPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Mission_completeness_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Mission_completeness_feature",
								"_UI_Mission_type"),
						C2systemPackage.Literals.MISSION__COMPLETENESS, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(C2systemPackage.Literals.MISSION__TASKS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Mission_type") + " " + mission.getId();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(C2systemPackage.Literals.MISSION__TASKS, C2systemFactory.eINSTANCE.createTask()));
	}
